    ...
    <div class="container-fluid">
        <div class="row" style="margin-bottom: 0;font-weight: bold">
            ...
            <div class="col-xs-2" style="padding-top: 40px;">
                ...
                <p>Tanggal:</p>
                <p>Kepada YTH:</p>
                <p style="font-size: 10px;" class="text-center"><?= $data[0]['nama_penerima']; ?></p>
                <p style="font-size: 10px;"><?= $data[0]['alamat_penerima']; ?></p>
            </div>
        </div>
        <?php 
    $ongkir=0;
    ...
    ?>
        <div class="row">
            <div class="col-xs-12">
                <table class="table">
                    <tr>
                        <td style="width: 200px;" class="text-left"><?= $data[0]['no_transaksi']; ?> /
                            <?= $data[0]['no_transaksi_reff']; ?></td>
                        <td></td>
                        <td class="text-right">Pengirim : <?= $data[0]['nama_pengirim']; ?></td>
                    </tr>
                </table>
            </div>
        </div>
        <table class="table table-striped table-bordered" style="margin-bottom: 0px;">
            ...
            <tbody>
                <tr class="text-center">
                    <td class="text-center"><?= $data[0]['no_transaksi']; ?></td>
                    <td class="text-center"><?= $data[0]['no_transaksi_reff']; ?></td>
                    <td class="text-right"><?= $data[0]['jumlah_item']; ?></td>
                    <td><?= $data[0]['item']; ?></td>
                    <td class="text-right"><?= $data[0]['jumlah_berat']; ?></td>
