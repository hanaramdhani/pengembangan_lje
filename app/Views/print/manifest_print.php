    ...
    <div class="container-fluid">
        <div class="row" style="margin-bottom: 1rem; ">
            <div class="col-xs-1 logo">
                <img src="/assets/dist/img/lancar-jaya.png" alt="" style="max-width: 50px; padding:10px">
            </div>
            <div class="col-xs-3">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center"><?= t($item['pengiriman_reff']) ?></td>
                    <td class="text-right"><?= titik($item['koli']) ?></td>
                    <td class="text-left"><?= $item['item'] ?></td>
                    <td class="text-left"><?= $item['nama_pengirim'] ?></td>
                    <td class="text-left"><?= $item['nama_penerima'] ?></td>
                    <td class="text-right"><?= titik($item['berat']) ?> Kg</td>
                    <td class="text-right">
