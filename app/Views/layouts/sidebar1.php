...
<aside class="main-sidebar sidebar-dark-danger elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
            <div class="image">
                <img src="<?= session()->lampiran != '' ? base_url('img/' . session()->lampiran) : '/assets/dist/img/avatar5.png' ?> "
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li
                    class="nav-item <?= service('uri')->getSegment(4) == $menu['slug'] || service('uri')->getSegment(3) == $menu['slug'] ? 'menu-is-opening menu-open' : '' ?>">
                    <a href="<?= $menu['url'] ?>"
                        class="nav-link <?= service('uri')->getSegment(4) == $menu['slug'] || service('uri')->getSegment(3) == $menu['slug'] ? 'active' : '' ?> <?= service('uri')->getSegment(1) == '' && $menu['nama_menu'] == 'Dashboard' ? 'active' : '' ?>">
                        <i class="<?= $menu['icon'] ?>"></i>
                        <p>
                            <?= $menu['nama_menu'] ?>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= $subMenu['url'] ?>"
                                class="nav-link <?= service('uri')->getSegment(3) == $subMenu['slug'] ? 'active' : '' ?>">
