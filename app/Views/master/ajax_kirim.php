...
?>
    <div class="card">
        <div class="card-body">
            <a class="btn btn-primary" href="<?= site_url('load/add/kirim/master') ?>"><i class="fas fa-plus-circle"></i> Tambah Data</a>
        </div>
    </div>
    <div class="card card-danger card-outline">
        <div class="card-body">
            <table id="data-tampil" class="table table-hover table-striped table-bordered" style="width:100%">
                <thead>
                    ...
                    <?php foreach ($kirim as $key => $value) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-block btn-xs <?= $value->status == 1 ? 'btn-success' : 'btn-danger' ?> edit-status" data-key='<?= $value->kd_kirim ?>'><?= $value->status == 1 ? 'Aktif' : 'Nonaktif' ?></button>
                            </td>
                            <td class="text-center">
                                <button class="btn btn-xs btn-block <?= $value->lampiran != '' ? 'btn-info' : 'btn-secondary disabled' ?>"><i class="far fa-eye"></i> Lihat</button>
                            </td>
                            <td class="text-center" width="160px">
                                <button type="button" class="btn btn-info btn-xs data-tampil" id="data-tampil" data-key="<?= $value->kd_kirim ?>">
                                    <i class="fa fa-eye"></i>
                                </button>
                                <button type="button" class="btn btn-warning btn-xs edit-master" data-key="<?= $value->kd_kirim ?>">
    ...
    <form id="frm-kirim" action="#">
                ...
                <div class="card card-danger card-outline">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control select2 data-dt w-100" name="val_kd_layanan" param="val_kd_layanan" id="add-modal-select-layanan">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3" id="radio-aktif1">
                                <p><input class="radio-dt-status" type='radio' name="val_status_dt" id="status-dt-non-aktif" param="val_status" value="0" /> Non-Akif</p>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="offset-md-4 col-sm-7">
                                <div class="btn_tambah">
                                    <button type="button" class="btn btn-primary" data-row="-1" data-aksi="tambah" id="add-detail">
                                        Tambah Detail
                                    </button>
        ...
        <div class="d-flex">
            <div class="text-center mx-auto mb-5">
                <button type="submit" id="send-ajax-array-js" name="simpan" class="form-control center-block btn-primary"><i class="fas fa-save mr-2"></i> Simpan Data</button>
            </div>
        </div>
    ...
    <div class="card card-info">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="row">
                        <img id="frameg1" src="" style=" width: 100px; height:100px;" />
                    </div>
                    <div class="row mt-2">
                        <input class="data" type="file" name="val_lampiran" onchange="previewg1()">
                    </div>
                </div>
            </div>
            <!-- End Kolom Lampiran  -->
        ...
        <script>
            function previewg1() {
                let frame = document.getElementById('frameg1');
