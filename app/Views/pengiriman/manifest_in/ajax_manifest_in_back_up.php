...
<form id="frm-manifest" action="">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="Isi Kode Referensi"
                                                ...
                                                name="val_no_transaksi_reff" value="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control data" id="val-kd-asal" readonly
                                            name="val_kd_asal" placeholder="Divisi Asal" value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control data" id="val-kd-asal" readonly
                                            name="val_kd_tujuan" placeholder="No. Refferensi" value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    <div class="card card-danger card-outline" style="min-height: 200px;">
        <div class="card-body">
            ...
            <table class="table table-hover table-striped table-bordered" id="detail-manifest"
...
function getKodeReff() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {
            reff_manifest: `${$('input[name=val_no_transaksi_reff]').val()}`,
            token: '<?= $_SESSION['token']; ?>'
        },
        success: function(res) {
            console.log(res);
...
$('input[name=val_no_transaksi_reff]').keypress(function(e) {
    if (e.keyCode == '13') {
        getKodeReff()
    }
})
