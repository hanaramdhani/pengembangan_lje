            ...
            <div class="tab-content" id="">
                        ...
                        <tbody>
                            <?php foreach ($manifest_out_pending as $data => $value) : ?>
                                <tr>
                                    ...
                                    <td><?= $value->asal ?></td>
                                    <td><?= $value->tujuan ?></td>
                                    <td style="text-align: right;"><?= "Rp ".number_format($value->total_pengiriman,0,',','.') ?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php endif ?>
                                        <a href="<?= base_url('printController/generatemPDF/manifest?no_transaksi=' . $value->no_transaksi . '&title=Struk Manifest'); ?>" target="_blank" class="btn btn-xs btn-default"><i class="fas fa-print"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <div class="tab-pane fade" id="history-manifest-tab-content" role="tabpanel" aria-labelledby="history-manifest-tab">
                    <table id="table-history" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php foreach ($t_manifest as $data => $value) : ?>
                                <tr>
    ...
    <script type="text/javascript">
        ...
        $('#table-manifest').on('click', '.lihat-data', function() {
            ...
            if (row.child.isShown()) {
                ...
                $.ajax({
                    type:'POST',
                    url:`<?=base_url() ?>/api/get_manifest_out_dt`,
                    data: {
                        key_manifest: $(this).data('key'),
