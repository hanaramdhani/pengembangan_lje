...
<div class="card card-outline card-danger">
    <div class="card-body">
        <form class="form-horizontal" id="frm-pengiriman" autocomplete="off">
            <div class="card-body">
                <div class="tab-content" id="tab-pengirimanContent">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control data" name="val_kd_lokasi_asal" id="kota-asal"
                                    placeholder="Area pengirim" required value="<?=$_SESSION['lokasi_def'] ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group display-hide" id="lama-kredit-group" style="margin-top: 2rem ">
                                <label style="display: none;" id="lbl-lm">Lama Kredit</label>
                                <div class="input-group">
                                    <input type="hidden" class="form-control data" id="lama-kredit"
                                        name="val_lama_kredit" placeholder="Masukkan Lama Kredit" value="0" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3" style="color: green"><input type="radio" name="checked_customer"
                                    class="checked-customer" value="penerima" checked> Set Sebagai Customer</div>
                            <div class=" form-group row">
                                <label class="col-sm-7 col-form-label">Nama</label>
                                <div class="col-sm-10">
                        ...
                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control display-hide" id="berat-min"
                                                    value="min" disabled>
                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 volume-r">
                                        <input type="text" class="form-control data-dt allow-numeric" value=""
                                            id="val_lebar" param="val_lebar" name="val_lebar" placeholder="Lebar (m)"
                                            onkeyup="total()">
                                    </div>
                                    <div class="col-md-4 volume-r">
                                        ...
                                        <input type="text" class="form-control data-dt allow-numeric" id="val_tinggi"
                                            param="val_tinggi" value="" name="val_tinggi" placeholder="Tinggi (m)"
                                            onkeyup="total()">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row align-items-center">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" value="0" class="form-control" id="hrg_volume"
                                                    name="hrg_volume" readonly>
                                                <input type="text" class="form-control display-hide" id="volume-min"
                                                    value="min" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <input type="hidden" value="0" id="val_harga_volume" param="val_harga_volume"
                                        onkeyup="total()" class="data-dt" name="val_harga_volume" onchange="total()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" min="0" maxlength="" oninput="Check(this)"
                                        class="form-control allow-numeric" id="diskon" onkeyup="total()" value="0"
                                        readonly placeholder="Diskon"
            ...
            <div class="">
                <div class="btn-batal">
                    ...
                    <button type="submit" name="simpan" style="float: right;margin-right: 20px" class="btn btn-primary"
                        id="btn-save"><i class="fas fa-save"></i> Simpan</button>
                </div>
            </div>
        </form>
    </div>
