            ...
            <tbody>
                ...
                <tr>
                    <td><button type="button" class="btn btn-info btn-xs data-tampil text-left"
                            ...
                            <i class="fa fa-eye"></i></button><?= $value->no_transaksi ?></td>
                        ...
                        <div class="tab-pane fade active show" id="tab-pengiriman-dsr-form" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="subject" class="col-sm-3 col-form-label">Jenis Pembayaran</label>
                                        <div class="col-sm-7">
                        ...
                        <div class="tab-pane fade" id="tab-pengiriman-paket-form" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    // $('#kota-tujuan-list').click(function() {
                                    //     let option=``;
                                    //     $.ajax({
                                    //         type: 'POST',
                                    //         url: `<?= base_url() ?>/api/get_jenis_kirim`,
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="val_jumlah_berat" param="val_jumlah_berat"
                                                    name="val_jumlah_berat" min="1" class="data-dt form-control"
                                ...
                                <div class="col-md-4">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-6">
                                                <input type="number" min="0" max="99" maxlength="" oninput="Check(this)"
                                                    ...
                                                    param="val_diskon" readonly>
                                            </div>
                                            <div class="col-md-3">
                                                <button id="persen" class="btn btn-sm btn-secondary w-75">%</button>
                                            </div>
                                            <div class="col-md-3">
                                                <button id="rupiah" class="btn btn-sm btn-secondary w-75">Rp.</button>
                                            </div>
                                        </div>
                                    </div>
                                    <script type="text/javascript">
                                    ...
                                    $('#persen').click(function() {
                                        $('#diskon').attr('maxlength', '3');
                                        $('#diskon').attr('readonly', false);
                                    });
                                    $('#rupiah').click(function() {
                                        $('#diskon').attr('maxlength', '10');
                                        $('#diskon').attr('readonly', false);
                                    });
