...
<div class="row">
    <div class="col-md-12">
        <div class="card card-danger card-tabs">
            ...
            <form class="form" id="frm-pengiriman">
                <div class="card-body">
                    <div class="tab-content" id="tab-pengirimanContent">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="subject" class="control-label">Jenis Layanan</label>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="val_kd_divisi" id="val_kd_divisi" param="val_kd_divisi"
                                    ...
                                    <option value="<?php echo $value->kd_divisi; ?>"
                                        <?= ($_SESSION['kd_divisi'] == $value->kd_divisi) ? 'selected' : '' ?>>
                                        <?php echo $value->nama ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6" id="radio-aktif">
                                    <input id='status-1' type='radio' name="val_status" onclick="coba()" value='1'
                                        class="data" checked />
                                    <label for="status-1" class="form-check-label">Tunai</label>
                                </div>
                                <div class="form-group">
                                    <label>Divisi</label>
                                    <select name="val_kd_divisi" id="val_kd_divisi" param="val_kd_divisi"
                            ...
                            <div class="col-md-4">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-6" id="radio-aktif1">
                                        <input id="status-0" type='radio' name="val_status" onclick="coba1()" value='0'
                                            class="data" />
                                        <label for="status-0" class="form-check-label">Kredit</label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="subject">Jenis Pembayaran</label>
                                    <select name="val_kd_jenis_bayar" param="val_kd_jenis_bayar"
                                        class="form-control select2 data">
                                ...
                                <div class="form-group">
                                    <label id="lbl-lama-kredit" style="display: none;">Lama Kredit</label>
                                    <input type="text" style="display: none;" value="0" class="form-control data"
                                        id="lama-kredit" name="val_lama_kredit" placeholder="Masukkan Lama Kredit"
                                        required>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="number" style="display: none;" min="0"
                                            ...
                                            <div class="col-md-3">
                                                <button type="button" style="display: none;" id="persen_master"
                                                    class="btn btn-secondary w-80">%</button>
                                            </div>
                                            <div class="col-md-3">
                                                <button type="button" style="display: none;" id="rupiah_master"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea id="val_keterangan" name="val_keterangan" param="val_keterangan" rows="2"
                                        class="form-control data" placeholder="Masukkan Keterangan"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="subject">Lampiran</label>
                                    <div class="col pl-0 mb-2">
                                        <div class="img-preview">
                                            <img id="lampiran" src="/assets/dist/img/fa-solid_image.png"
                                                class="w-100 p-4">
                                        </div>
                                    </div>
                                    <div class="col pl-0">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="val_kd_jenis" id="val-kd-jenis" param="val_kd_jenis"
                                        class="form-control select2 data-dt ongkir">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control data-dt" onkeyup="resultsubtotal()"
                                        param="val_harga_koli" name="val_harga_koli" id="harga_koli" readonly>
                                </div>
                                ...
                                $('#val-kd-jenis').change(function() {
                                            if ($(this).val() != '') {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(r) {
                                                        ...
                                                        $('#label_harga_berat').html("Rp. " +
                                                            r.harga_berat);
                                                        $('#label_min_berat').html("Minimal Berat :" + r
                                                            .min_berat);
                                                        $('#label_harga_volume').html("Rp. " +
                                                            r.harga_volume);
                                                        $('#label_min_volume').html("Minimal Volume :" + r
                                                            .min_volume);
                                                ...
                                                $('.call-modal').click(function() {
                                                    ...
                                                    $.ajax({
                                                        type: 'POST',
                                                        url: `<?= base_url() ?>/ajax_load/${act}/${page}/${jenis}/` +
                                                            key + '/true',
                                                        success: function(r) {
                                                            $('#m-crud-title-panggil').text(
                                                                title_modal);
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" id="val_jumlah_berat" name="val_jumlah_berat"
                                                    param="val_jumlah_berat" name="val_jumlah_berat"
                                                    class="data-dt form-control" placeholder="Masukkan berat" value=""
                                                    onkeyup="resultberat()">
                                            </div>
                                            <div>
                                                <input type="hidden" class="data-dt" id="harga_berat"
                                                    param="harga_berat" onkeyup="resultsubtotal()">
                                            </div>
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <span id="label_harga_berat" class="input-group-text"></span>
                                            </div>
                                            <div class="input-group-append">
                                                <!-- <span id="label_min_berat" class="input-group-text"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row align-items-center">
                                            <div>
                                                <label>hidden</label>
                                                <input type="hidden" id="val_harga_volume" name="val_harga_volume"
                                                    param="val_harga_volume" onkeyup="resultvolume()" class="data-dt"
                                            ...
                                            <div>
                                                <label>hidden</label>
                                                <input type="hidden" id="harga_volume" class="data-dt"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <input type="number" min="0" max="99" maxlength="" oninput="Check(this)"
                                                class="form-control data-dt" id="diskon" onkeyup="total()" value="0"
                                                param="val_diskon" name="val_diskon_dt" readonly>
                                        </div>
                                        <div class="col-md-3">
                                            <button type="button" id="persen"
                                                class="btn btn-sm btn-secondary w-75">%</button>
                                        </div>
                                        <div class="col-md-3">
                                            <button type="button" id="rupiah"
                                                class="btn btn-sm btn-secondary w-75">Rp.</button>
                                        </div>
                                    </div>
                                </div>
                                    <label class="form-label">Diskon</label>
                                    <input type="text" id="discount-val" name="diskon" param="val_diskon"
                                        class="data-dt">
                                    <div class="input-group">
                                        <input type="number" min="0" maxlength="" oninput="Check(this)"
                                            class="form-control" id="diskon" onkeyup="total()" value="0" readonly
                                            placeholder="Diskon">
                                    ...
                                    $('#persen_master').click(function() {
                                        ...
                                        $('#persen_master').attr('class', 'btn btn-success form-control')
                                        $('#rupiah_master').attr('class', 'btn btn-secondary form-control')
                                    });
                                    ...
                                    $('#rupiah').click(function() {
                                        $('#diskon').attr('maxlength', '5')
                                        //  ($('#val_subtotal').attr('value')));
                                        $('#diskon').attr('readonly', false);
                            ...
                            <button type="button" class="btn btn-success btn-sm" name="tambah" data-row="-1"
                                        ...
                                        <div class="card-footer">
                                            <div>
                                                <button type="submit" name="simpan"
                                                    ...
                                                    class="form-control btn-primary"><i class="fas fa-save"></i>
                                                    Simpan</button>
                                            </div>
                                        </div>
            </form>
